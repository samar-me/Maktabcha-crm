...
export async function POST(req: Request) {
  ...
  const result = streamText({
    model: google("gemini-1.5-pro"), // or 1.5-pro, depending on API access. We will use gemini-1.5-pro as fallback if 2.5 is not available. Wait, 1.5-flash is faster and works well.
